...
#Defining the Labels
message = Label(window, text="Image-Text-Speech Converter" ,bg="#000000"  ,fg="#FFFF00"  ,width=50  ,height=3,font=('Helvetica', 35, 'italic bold '))
message.place(x=60, y=10)
message = Label(window, text=" " ,bg="#000000"  ,fg="#FF0000"  ,width=70  ,height=2,font=('Helvetica', 15, 'italic bold '))
